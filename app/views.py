...
class MedicineSearchView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):  # new
        ...
        object_list = MedicinePost.objects.filter(
            Q(medicine_name__contains=query.rstrip().lstrip()) | Q(medicine_name__contains=query.lower().rstrip().lstrip()) | Q(medicine_name__contains=query.capitalize().rstrip().lstrip())
        )
