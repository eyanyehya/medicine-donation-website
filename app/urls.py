...
from .views import HomePageView, AboutPageView, PostDetailView, PostUpdateView, PostDeleteView, PostCreateView, NavBarView, MedicineListPageView, MedicineSearchView, TermsView, MyPostsListView
